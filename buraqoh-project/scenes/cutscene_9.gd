...
func _ready() -> void:
	DialogueManager.show_dialogue_balloon(load("res://Dialogo/SueliFatimaeDjalmaDjalmaNoivas.dialogue" ),"start")
...
func entradaDramatica() -> void:
	anim_player.play("DjalmaEntrando")
